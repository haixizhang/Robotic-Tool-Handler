...
namespace intera_core_msgs
{
  ...
  class InteractionControlState : public ros::Msg
  {
    public:
      ...
      typedef float _endpoint_force_command_type;
    ...
    InteractionControlState():
      ...
      endpoint_force_command_length(0), st_endpoint_force_command(), endpoint_force_command(nullptr),
      endpoint_name(""),
      in_endpoint_frame(0),
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (this->endpoint_force_command_length >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->endpoint_force_command[i]);
      }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(endpoint_force_command_lengthT > endpoint_force_command_length)
        this->endpoint_force_command = (float*)realloc(this->endpoint_force_command, endpoint_force_command_lengthT * sizeof(float));
      endpoint_force_command_length = endpoint_force_command_lengthT;
      for( uint32_t i = 0; i < endpoint_force_command_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_endpoint_force_command));
        memcpy( &(this->endpoint_force_command[i]), &(this->st_endpoint_force_command), sizeof(float));
      }
    ...
    virtual const char * getType() override { return "intera_core_msgs/InteractionControlState"; };
    virtual const char * getMD5() override { return "f3fbd4a2356cb48da2df759db65614d8"; };
