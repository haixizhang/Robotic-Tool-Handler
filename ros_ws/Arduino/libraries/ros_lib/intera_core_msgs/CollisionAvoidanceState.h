...
namespace intera_core_msgs
{
  ...
  class CollisionAvoidanceState : public ros::Msg
  {
    ...
    CollisionAvoidanceState():
      header(),
      other_arm(0),
      collision_object_length(0), st_collision_object(), collision_object(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "intera_core_msgs/CollisionAvoidanceState"; };
    virtual const char * getMD5() override { return "30f5cb8ae019f1ffe8b599e6d2e589c7"; };
