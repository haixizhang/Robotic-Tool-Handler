...
namespace intera_core_msgs
{
  ...
  class IONodeConfiguration : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "intera_core_msgs/IONodeConfiguration"; };
    virtual const char * getMD5() override { return "66800b32dbb52df00e2454d58668ac33"; };
