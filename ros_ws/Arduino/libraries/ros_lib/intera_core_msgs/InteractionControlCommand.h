...
namespace intera_core_msgs
{
  ...
  class InteractionControlCommand : public ros::Msg
  {
    public:
      ...
      typedef float _K_impedance_type;
    ...
    InteractionControlCommand():
      ...
      K_impedance_length(0), st_K_impedance(), K_impedance(nullptr),
      max_impedance_length(0), st_max_impedance(), max_impedance(nullptr),
      D_impedance_length(0), st_D_impedance(), D_impedance(nullptr),
      K_nullspace_length(0), st_K_nullspace(), K_nullspace(nullptr),
      force_command_length(0), st_force_command(), force_command(nullptr),
      interaction_frame(),
      endpoint_name(""),
      in_endpoint_frame(0),
      disable_damping_in_force_control(0),
      disable_reference_resetting(0),
      interaction_control_mode_length(0), st_interaction_control_mode(), interaction_control_mode(nullptr),
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (this->K_impedance_length >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->K_impedance[i]);
      }
      ...
      *(outbuffer + offset + 3) = (this->D_impedance_length >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->D_impedance[i]);
      }
      ...
      *(outbuffer + offset + 3) = (this->K_nullspace_length >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->K_nullspace[i]);
      }
      ...
      *(outbuffer + offset + 3) = (this->force_command_length >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->force_command[i]);
      }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(K_impedance_lengthT > K_impedance_length)
        this->K_impedance = (float*)realloc(this->K_impedance, K_impedance_lengthT * sizeof(float));
      K_impedance_length = K_impedance_lengthT;
      for( uint32_t i = 0; i < K_impedance_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_K_impedance));
        memcpy( &(this->K_impedance[i]), &(this->st_K_impedance), sizeof(float));
      }
      ...
      if(D_impedance_lengthT > D_impedance_length)
        this->D_impedance = (float*)realloc(this->D_impedance, D_impedance_lengthT * sizeof(float));
      D_impedance_length = D_impedance_lengthT;
      for( uint32_t i = 0; i < D_impedance_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_D_impedance));
        memcpy( &(this->D_impedance[i]), &(this->st_D_impedance), sizeof(float));
      }
      ...
      if(K_nullspace_lengthT > K_nullspace_length)
        this->K_nullspace = (float*)realloc(this->K_nullspace, K_nullspace_lengthT * sizeof(float));
      K_nullspace_length = K_nullspace_lengthT;
      for( uint32_t i = 0; i < K_nullspace_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_K_nullspace));
        memcpy( &(this->K_nullspace[i]), &(this->st_K_nullspace), sizeof(float));
      }
      ...
      if(force_command_lengthT > force_command_length)
        this->force_command = (float*)realloc(this->force_command, force_command_lengthT * sizeof(float));
      force_command_length = force_command_lengthT;
      for( uint32_t i = 0; i < force_command_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_force_command));
        memcpy( &(this->force_command[i]), &(this->st_force_command), sizeof(float));
      }
    ...
    virtual const char * getType() override { return "intera_core_msgs/InteractionControlCommand"; };
    virtual const char * getMD5() override { return "762b5d197d5d786f83741af7fe6261a6"; };
