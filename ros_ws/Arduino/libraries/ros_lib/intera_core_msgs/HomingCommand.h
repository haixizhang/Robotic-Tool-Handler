...
namespace intera_core_msgs
{
  ...
  class HomingCommand : public ros::Msg
  {
    ...
    HomingCommand():
      ...
      command_length(0), st_command(), command(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "intera_core_msgs/HomingCommand"; };
    virtual const char * getMD5() override { return "ff29c86109f0f4cada5bbde945dd55c4"; };
