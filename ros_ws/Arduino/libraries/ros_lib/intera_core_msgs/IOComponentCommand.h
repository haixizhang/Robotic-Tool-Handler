...
namespace intera_core_msgs
{
  ...
  class IOComponentCommand : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "intera_core_msgs/IOComponentCommand"; };
    virtual const char * getMD5() override { return "ede95ba2953dc221dc82cac20f697530"; };
