...
namespace intera_core_msgs
{
  ...
  class EndpointNamesArray : public ros::Msg
  {
    ...
    EndpointNamesArray():
      endpoint_names_length(0), st_endpoint_names(), endpoint_names(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "intera_core_msgs/EndpointNamesArray"; };
    virtual const char * getMD5() override { return "6bf0a2d04056051f84da1291f261f35a"; };
