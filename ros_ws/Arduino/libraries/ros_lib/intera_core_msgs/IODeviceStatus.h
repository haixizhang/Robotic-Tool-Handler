...
namespace intera_core_msgs
{
  ...
  class IODeviceStatus : public ros::Msg
  {
    ...
    IODeviceStatus():
      ...
      signals_length(0), st_signals(), signals(nullptr),
      commands_length(0), st_commands(), commands(nullptr),
      responses_length(0), st_responses(), responses(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "intera_core_msgs/IODeviceStatus"; };
    virtual const char * getMD5() override { return "0d0c97a2d700848e7ad46e09a77cf896"; };
