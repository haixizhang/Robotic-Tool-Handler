...
namespace intera_core_msgs
{
  ...
  class CollisionDetectionState : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "intera_core_msgs/CollisionDetectionState"; };
    virtual const char * getMD5() override { return "7bde38c182b4d08fdc0635b116f65d04"; };
