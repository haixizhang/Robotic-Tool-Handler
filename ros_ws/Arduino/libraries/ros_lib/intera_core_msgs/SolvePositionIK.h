...
static const char SOLVEPOSITIONIK[] = "intera_core_msgs/SolvePositionIK";
  ...
  class SolvePositionIKRequest : public ros::Msg
  {
    public:
      ...
      typedef float _nullspace_gain_type;
    ...
    SolvePositionIKRequest():
      pose_stamp_length(0), st_pose_stamp(), pose_stamp(nullptr),
      seed_angles_length(0), st_seed_angles(), seed_angles(nullptr),
      seed_mode(0),
      use_nullspace_goal_length(0), st_use_nullspace_goal(), use_nullspace_goal(nullptr),
      nullspace_goal_length(0), st_nullspace_goal(), nullspace_goal(nullptr),
      nullspace_gain_length(0), st_nullspace_gain(), nullspace_gain(nullptr),
      tip_names_length(0), st_tip_names(), tip_names(nullptr)
    {
    }
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (this->nullspace_gain_length >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->nullspace_gain[i]);
      }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(nullspace_gain_lengthT > nullspace_gain_length)
        this->nullspace_gain = (float*)realloc(this->nullspace_gain, nullspace_gain_lengthT * sizeof(float));
      nullspace_gain_length = nullspace_gain_lengthT;
      for( uint32_t i = 0; i < nullspace_gain_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_nullspace_gain));
        memcpy( &(this->nullspace_gain[i]), &(this->st_nullspace_gain), sizeof(float));
      }
    ...
    virtual const char * getType() override { return SOLVEPOSITIONIK; };
    virtual const char * getMD5() override { return "b09dd99695bb18639bfea7c92d0a89ca"; };
  ...
  class SolvePositionIKResponse : public ros::Msg
  {
    ...
    SolvePositionIKResponse():
      ...
      result_type_length(0), st_result_type(), result_type(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return SOLVEPOSITIONIK; };
    virtual const char * getMD5() override { return "d47b4ca70898ba1b2f99ffdf9b81d911"; };
