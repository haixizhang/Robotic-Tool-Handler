...
static const char SOLVEPOSITIONFK[] = "intera_core_msgs/SolvePositionFK";
  ...
  class SolvePositionFKRequest : public ros::Msg
  {
    ...
    SolvePositionFKRequest():
      configuration_length(0), st_configuration(), configuration(nullptr),
    ...
    virtual const char * getType() override { return SOLVEPOSITIONFK; };
    virtual const char * getMD5() override { return "14c88cbabc4e4d6c183969e91f5e56ca"; };
  ...
  class SolvePositionFKResponse : public ros::Msg
  {
    ...
    SolvePositionFKResponse():
      ...
      isValid_length(0), st_isValid(), isValid(nullptr),
      inCollision_length(0), st_inCollision(), inCollision(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return SOLVEPOSITIONFK; };
    virtual const char * getMD5() override { return "907cf9ee4b255127ce59627076bd1e85"; };
