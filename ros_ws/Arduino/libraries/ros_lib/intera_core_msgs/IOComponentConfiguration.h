...
namespace intera_core_msgs
{
  ...
  class IOComponentConfiguration : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "intera_core_msgs/IOComponentConfiguration"; };
    virtual const char * getMD5() override { return "cb7717d13a521b51b5c0a02d493c42fd"; };
