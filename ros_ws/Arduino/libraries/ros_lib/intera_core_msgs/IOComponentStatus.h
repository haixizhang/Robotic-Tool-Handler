...
namespace intera_core_msgs
{
  ...
  class IOComponentStatus : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "intera_core_msgs/IOComponentStatus"; };
    virtual const char * getMD5() override { return "7daed407477edd76573df598b0375a48"; };
