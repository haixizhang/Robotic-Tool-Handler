...
namespace intera_core_msgs
{
  ...
  class URDFConfiguration : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "intera_core_msgs/URDFConfiguration"; };
    virtual const char * getMD5() override { return "0c7028d878027820eed2aa0cbf1f5e4a"; };
