...
namespace intera_motion_msgs
{
  ...
  class TrajectoryAnalysis : public ros::Msg
  {
    ...
    TrajectoryAnalysis():
      planned_duration(0),
      measured_duration(0),
      min_angle_command_length(0), st_min_angle_command(), min_angle_command(nullptr),
      max_angle_command_length(0), st_max_angle_command(), max_angle_command(nullptr),
      peak_speed_command_length(0), st_peak_speed_command(), peak_speed_command(nullptr),
      peak_accel_command_length(0), st_peak_accel_command(), peak_accel_command(nullptr),
      peak_jerk_command_length(0), st_peak_jerk_command(), peak_jerk_command(nullptr),
      min_time_rate(0),
      max_time_rate(0),
      max_position_error_length(0), st_max_position_error(), max_position_error(nullptr),
      max_velocity_error_length(0), st_max_velocity_error(), max_velocity_error(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "intera_motion_msgs/TrajectoryAnalysis"; };
    virtual const char * getMD5() override { return "f30ec541413b4eb2cecc0d0af7d30ad4"; };
