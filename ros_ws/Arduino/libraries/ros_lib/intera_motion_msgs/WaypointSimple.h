...
namespace intera_motion_msgs
{
  ...
  class WaypointSimple : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "intera_motion_msgs/WaypointSimple"; };
    virtual const char * getMD5() override { return "f29bcd94cca5f378ef52eb965645d7ce"; };
