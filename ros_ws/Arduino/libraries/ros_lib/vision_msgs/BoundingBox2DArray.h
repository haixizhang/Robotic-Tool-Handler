#ifndef _ROS_vision_msgs_BoundingBox2DArray_h
#define _ROS_vision_msgs_BoundingBox2DArray_h
...
namespace vision_msgs
{
  ...
  class BoundingBox2DArray : public ros::Msg
  {
    public:
      typedef std_msgs::Header _header_type;
      _header_type header;
      uint32_t boxes_length;
      typedef vision_msgs::BoundingBox2D _boxes_type;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(boxes_lengthT > boxes_length)
        this->boxes = (vision_msgs::BoundingBox2D*)realloc(this->boxes, boxes_lengthT * sizeof(vision_msgs::BoundingBox2D));
      boxes_length = boxes_lengthT;
      for( uint32_t i = 0; i < boxes_length; i++){
      offset += this->st_boxes.deserialize(inbuffer + offset);
        memcpy( &(this->boxes[i]), &(this->st_boxes), sizeof(vision_msgs::BoundingBox2D));
      }
     return offset;
    }

    virtual const char * getType() override { return "vision_msgs/BoundingBox2DArray"; };
    virtual const char * getMD5() override { return "583fadc917b98c913c8ed3ee2bf4514a"; };
