...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.trajectory_options.interaction_params.interaction_control_active
      buff.write(_get_struct_B().pack(_x))
      length = len(self.trajectory_options.interaction_params.K_impedance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_options.interaction_params.K_impedance))
      length = len(self.trajectory_options.interaction_params.max_impedance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_options.interaction_params.max_impedance))
      length = len(self.trajectory_options.interaction_params.D_impedance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_options.interaction_params.D_impedance))
      length = len(self.trajectory_options.interaction_params.K_nullspace)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_options.interaction_params.K_nullspace))
      length = len(self.trajectory_options.interaction_params.force_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_options.interaction_params.force_command))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_options.tracking_options.goal_joint_tolerance))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.trajectory_options.interpolation_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.trajectory_options.interaction_params.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.trajectory_options.interaction_params.K_impedance = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.trajectory_options.interaction_params.max_impedance = s.unpack(str[start:end])
      self.trajectory_options.interaction_params.max_impedance = list(map(bool, self.trajectory_options.interaction_params.max_impedance))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.trajectory_options.interaction_params.D_impedance = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.trajectory_options.interaction_params.K_nullspace = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.trajectory_options.interaction_params.force_command = s.unpack(str[start:end])
      _x = self
      start = end
      end += 56
      ...
      if python3:
        self.trajectory_options.interaction_params.endpoint_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.trajectory_options.tracking_options.goal_joint_tolerance = s.unpack(str[start:end])
      _x = self
      start = end
      end += 25
