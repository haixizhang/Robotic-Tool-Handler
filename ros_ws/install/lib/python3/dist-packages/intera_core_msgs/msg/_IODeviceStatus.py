...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.device.status.tag = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.device.status.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.device.status.detail = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v3.tag = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v3.detail = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v7.tag = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v7.detail = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v8.tag = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v8.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v8.detail = str[start:end].decode('utf-8', 'rosmsg')
        else:
