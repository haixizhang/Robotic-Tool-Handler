...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.interaction_control_active
      buff.write(_get_struct_B().pack(_x))
      length = len(self.K_impedance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.K_impedance))
      length = len(self.max_impedance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.Struct(pattern).pack(*self.max_impedance))
      length = len(self.D_impedance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.D_impedance))
      length = len(self.K_nullspace)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.K_nullspace))
      length = len(self.force_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.force_command))
      _x = self
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.rotations_for_constrained_zeroG
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.K_impedance = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.max_impedance = s.unpack(str[start:end])
      self.max_impedance = list(map(bool, self.max_impedance))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.D_impedance = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.K_nullspace = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.force_command = s.unpack(str[start:end])
      _x = self
      start = end
      end += 56
      ...
      if python3:
        self.endpoint_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
