...
class IOComponentCommandSrvRequest(genpy.Message):
  ...
  _full_text = """## IO Component Command service call
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.command.op = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.command.args = str[start:end].decode('utf-8', 'rosmsg')
      else:
...
class IOComponentCommandSrvResponse(genpy.Message):
  ...
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """time time               # time the request was handled, serves as a sequence number
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.status.tag = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.status.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
