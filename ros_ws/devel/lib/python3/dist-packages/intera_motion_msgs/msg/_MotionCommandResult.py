...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_analysis.min_angle_command))
      length = len(self.trajectory_analysis.max_angle_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_analysis.max_angle_command))
      length = len(self.trajectory_analysis.peak_speed_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_analysis.peak_speed_command))
      length = len(self.trajectory_analysis.peak_accel_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_analysis.peak_accel_command))
      length = len(self.trajectory_analysis.peak_jerk_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_analysis.peak_jerk_command))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_analysis.max_position_error))
      length = len(self.trajectory_analysis.max_velocity_error)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.trajectory_analysis.max_velocity_error))
      _x = self.last_successful_waypoint
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.errorId = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.trajectory_analysis.min_angle_command = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.trajectory_analysis.max_angle_command = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.trajectory_analysis.peak_speed_command = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.trajectory_analysis.peak_accel_command = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.trajectory_analysis.peak_jerk_command = s.unpack(str[start:end])
      _x = self
      start = end
      end += 16
      ...
      self.trajectory_analysis.max_position_error = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.trajectory_analysis.max_velocity_error = s.unpack(str[start:end])
      start = end
      end += 4
