...
"""
    ...
    try:
      ...
      for val1 in self.action_goal.goal.trajectory.waypoints:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = _v7.max_joint_speed_ratio
        buff.write(_get_struct_d().pack(_x))
        length = len(_v7.joint_tolerances)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*_v7.joint_tolerances))
        length = len(_v7.max_joint_accel)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*_v7.max_joint_accel))
        _x = _v7
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.trajectory.trajectory_options.interaction_params.interaction_control_active
      buff.write(_get_struct_B().pack(_x))
      length = len(self.action_goal.goal.trajectory.trajectory_options.interaction_params.K_impedance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.trajectory.trajectory_options.interaction_params.K_impedance))
      length = len(self.action_goal.goal.trajectory.trajectory_options.interaction_params.max_impedance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.trajectory.trajectory_options.interaction_params.max_impedance))
      length = len(self.action_goal.goal.trajectory.trajectory_options.interaction_params.D_impedance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.trajectory.trajectory_options.interaction_params.D_impedance))
      length = len(self.action_goal.goal.trajectory.trajectory_options.interaction_params.K_nullspace)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.trajectory.trajectory_options.interaction_params.K_nullspace))
      length = len(self.action_goal.goal.trajectory.trajectory_options.interaction_params.force_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.trajectory.trajectory_options.interaction_params.force_command))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.trajectory.trajectory_options.tracking_options.goal_joint_tolerance))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.trajectory_analysis.min_angle_command))
      length = len(self.action_result.result.trajectory_analysis.max_angle_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.trajectory_analysis.max_angle_command))
      length = len(self.action_result.result.trajectory_analysis.peak_speed_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.trajectory_analysis.peak_speed_command))
      length = len(self.action_result.result.trajectory_analysis.peak_accel_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.trajectory_analysis.peak_accel_command))
      length = len(self.action_result.result.trajectory_analysis.peak_jerk_command)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.trajectory_analysis.peak_jerk_command))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.trajectory_analysis.max_position_error))
      length = len(self.action_result.result.trajectory_analysis.max_velocity_error)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.trajectory_analysis.max_velocity_error))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.trajectory.label = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.active_endpoint = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v14.label = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        _v14.joint_tolerances = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v14.max_joint_accel = s.unpack(str[start:end])
        _x = _v14
        start = end
        end += 40
      ...
      if python3:
        self.action_goal.goal.trajectory.trajectory_options.interpolation_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.trajectory.trajectory_options.interaction_params.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.action_goal.goal.trajectory.trajectory_options.interaction_params.K_impedance = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.action_goal.goal.trajectory.trajectory_options.interaction_params.max_impedance = s.unpack(str[start:end])
      self.action_goal.goal.trajectory.trajectory_options.interaction_params.max_impedance = list(map(bool, self.action_goal.goal.trajectory.trajectory_options.interaction_params.max_impedance))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.trajectory.trajectory_options.interaction_params.D_impedance = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.trajectory.trajectory_options.interaction_params.K_nullspace = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.trajectory.trajectory_options.interaction_params.force_command = s.unpack(str[start:end])
      _x = self
      start = end
      end += 56
      ...
      if python3:
        self.action_goal.goal.trajectory.trajectory_options.interaction_params.endpoint_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.action_goal.goal.trajectory.trajectory_options.tracking_options.goal_joint_tolerance = s.unpack(str[start:end])
      _x = self
      start = end
      end += 37
      ...
      if python3:
        self.action_result.result.errorId = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.action_result.result.trajectory_analysis.min_angle_command = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_result.result.trajectory_analysis.max_angle_command = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_result.result.trajectory_analysis.peak_speed_command = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_result.result.trajectory_analysis.peak_accel_command = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_result.result.trajectory_analysis.peak_jerk_command = s.unpack(str[start:end])
      _x = self
      start = end
      end += 16
      ...
      self.action_result.result.trajectory_analysis.max_position_error = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_result.result.trajectory_analysis.max_velocity_error = s.unpack(str[start:end])
      _x = self
      start = end
      end += 16
      ...
      if python3:
        self.action_feedback.feedback.status.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_feedback.feedback.status.motion_status = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_feedback.feedback.status.current_trajectory = str[start:end].decode('utf-8', 'rosmsg')
      else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v28.label = str[start:end].decode('utf-8', 'rosmsg')
        else:
