...
namespace intera_core_msgs
{
  ...
  class NavigatorState : public ros::Msg
  {
    ...
    NavigatorState():
      button_names_length(0), st_button_names(), button_names(nullptr),
      buttons_length(0), st_buttons(), buttons(nullptr),
      wheel(0),
      light_names_length(0), st_light_names(), light_names(nullptr),
      lights_length(0), st_lights(), lights(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "intera_core_msgs/NavigatorState"; };
    virtual const char * getMD5() override { return "680d121a1f16a32647298b292492fffd"; };
