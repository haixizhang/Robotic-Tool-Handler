...
namespace intera_core_msgs
{
  ...
  class JointLimits : public ros::Msg
  {
    ...
    JointLimits():
      ...
      position_lower_length(0), st_position_lower(), position_lower(nullptr),
      position_upper_length(0), st_position_upper(), position_upper(nullptr),
      velocity_length(0), st_velocity(), velocity(nullptr),
      accel_length(0), st_accel(), accel(nullptr),
    ...
    virtual const char * getType() override { return "intera_core_msgs/JointLimits"; };
    virtual const char * getMD5() override { return "c4c445eb2c9324525a704c84ca1e7598"; };
