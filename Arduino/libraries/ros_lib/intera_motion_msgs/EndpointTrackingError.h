...
namespace intera_motion_msgs
{
  ...
  class EndpointTrackingError : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "intera_motion_msgs/EndpointTrackingError"; };
    virtual const char * getMD5() override { return "c266cbf60fc5f871b5909394c05032fc"; };
