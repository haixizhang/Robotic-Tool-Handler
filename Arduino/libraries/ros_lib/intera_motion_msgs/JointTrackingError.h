...
namespace intera_motion_msgs
{
  ...
  class JointTrackingError : public ros::Msg
  {
    ...
    JointTrackingError():
      ...
      position_error_length(0), st_position_error(), position_error(nullptr),
      velocity_error_length(0), st_velocity_error(), velocity_error(nullptr),
    ...
    virtual const char * getType() override { return "intera_motion_msgs/JointTrackingError"; };
    virtual const char * getMD5() override { return "a564fcc23df67e287d3c4c2aa3aef83b"; };
