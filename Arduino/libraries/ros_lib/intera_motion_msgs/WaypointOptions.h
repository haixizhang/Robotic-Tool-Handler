...
namespace intera_motion_msgs
{
  ...
  class WaypointOptions : public ros::Msg
  {
    ...
    WaypointOptions():
      ...
      joint_tolerances_length(0), st_joint_tolerances(), joint_tolerances(nullptr),
      max_joint_accel_length(0), st_max_joint_accel(), max_joint_accel(nullptr),
      max_linear_speed(0),
      max_linear_accel(0),
    ...
    virtual const char * getType() override { return "intera_motion_msgs/WaypointOptions"; };
    virtual const char * getMD5() override { return "1b4687d4e536269b06e629169723339f"; };
