...
namespace intera_motion_msgs
{
  ...
  class TrackingOptions : public ros::Msg
  {
    ...
    TrackingOptions():
      ...
      use_max_time_rate(0),
      max_time_rate(0),
      goal_joint_tolerance_length(0), st_goal_joint_tolerance(), goal_joint_tolerance(nullptr),
    ...
    virtual const char * getType() override { return "intera_motion_msgs/TrackingOptions"; };
    virtual const char * getMD5() override { return "e848e8a266b514c3bde707d0e1859055"; };
