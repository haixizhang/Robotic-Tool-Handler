...
namespace intera_motion_msgs
{
  ...
  class InterpolatedPath : public ros::Msg
  {
    ...
    InterpolatedPath():
      ...
      interpolated_path_length(0), st_interpolated_path(), interpolated_path(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "intera_motion_msgs/InterpolatedPath"; };
    virtual const char * getMD5() override { return "4e078bdc2ed88b86420f5b19cbd78219"; };
